...
export default function SortableColorList({colors, setColors, onEdit, onSave, deleteColor}: any) {
        ...
        >
            ...
            >
                ...
                {colors.map((color: any) => (
                    <SortableItem key={color.id} color={color} onEdit={onEdit} deleteColor={deleteColor} />
                ))}
                </div>
            </SortableContext>
        </DndContext>
